...
#打開training data，讀取資料
file = open("/Users/evan/documents/university/Machine_Learning_Foundation/hw2/testing_data")
for line in file:
    lines = line.split(' ')
    xtest.append(float(lines[bestI + 1]))
    ytest.append(int(lines[10]))
file.close()
